 ...
 * Routing: this page is served at /u/[username] using Next.js App Router conventions.
 * Rendering: behavior depends on directives in this file (for example, 'use client' for client rendering).
 * ============================================
 */
